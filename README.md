...
Urho3D 2.0.1 provides optional Vulkan integration at buildtime, while retaining support for all legacy backends/platforms (it's non-invasive, and can be easily enabled/disabled via cmake).
