// ClaudeTerminal — Urho3D terminal emulator for Claude Code.
...
class ClaudeTerminal : public Application
{
    URHO3D_OBJECT(ClaudeTerminal, Application);

public:
    explicit ClaudeTerminal(Context* context);
    ~ClaudeTerminal() override;
