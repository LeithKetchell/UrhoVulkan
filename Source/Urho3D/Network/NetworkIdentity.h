...
/// %Network identity and replication settings component. Marks a node for network replication.
class URHO3D_API NetworkIdentity : public Component
{
    URHO3D_OBJECT(NetworkIdentity, Component);

public:
    /// Construct.
    explicit NetworkIdentity(Context* context);
    /// Destruct.
