...
void ASRegisterGeneratedGlobalVariables(asIScriptEngine* engine)
{
    ...
    engine->RegisterGlobalProperty("const String EP_VULKAN", (void*)&EP_VULKAN);
    ...
    engine->RegisterGlobalProperty("const String HashPSP_AMBIENTCOLOR", (void*)&PSP_AMBIENTCOLOR);

    // const StringHash PSP_CAMERAPOS | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_CAMERAPOS", (void*)&PSP_CAMERAPOS);

    // const StringHash PSP_DELTATIME | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_DELTATIME", (void*)&PSP_DELTATIME);

    // const StringHash PSP_DEPTHRECONSTRUCT | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_DEPTHRECONSTRUCT", (void*)&PSP_DEPTHRECONSTRUCT);

    // const StringHash PSP_ELAPSEDTIME | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_ELAPSEDTIME", (void*)&PSP_ELAPSEDTIME);

    // const StringHash PSP_FARCLIP | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_FARCLIP", (void*)&PSP_FARCLIP);

    // const StringHash PSP_FOGCOLOR | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_FOGCOLOR", (void*)&PSP_FOGCOLOR);

    // const StringHash PSP_FOGPARAMS | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_FOGPARAMS", (void*)&PSP_FOGPARAMS);

    // const StringHash PSP_GBUFFERINVSIZE | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_GBUFFERINVSIZE", (void*)&PSP_GBUFFERINVSIZE);

    // const StringHash PSP_LIGHTCOLOR | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_LIGHTCOLOR", (void*)&PSP_LIGHTCOLOR);

    // const StringHash PSP_LIGHTDIR | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_LIGHTDIR", (void*)&PSP_LIGHTDIR);

    // const StringHash PSP_LIGHTLENGTH | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_LIGHTLENGTH", (void*)&PSP_LIGHTLENGTH);

    // const StringHash PSP_LIGHTMATRICES | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_LIGHTMATRICES", (void*)&PSP_LIGHTMATRICES);

    // const StringHash PSP_LIGHTPOS | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_LIGHTPOS", (void*)&PSP_LIGHTPOS);

    // const StringHash PSP_LIGHTRAD | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_LIGHTRAD", (void*)&PSP_LIGHTRAD);

    // const StringHash PSP_MATDIFFCOLOR | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_MATDIFFCOLOR", (void*)&PSP_MATDIFFCOLOR);

    // const StringHash PSP_MATEMISSIVECOLOR | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_MATEMISSIVECOLOR", (void*)&PSP_MATEMISSIVECOLOR);

    // const StringHash PSP_MATENVMAPCOLOR | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_MATENVMAPCOLOR", (void*)&PSP_MATENVMAPCOLOR);

    // const StringHash PSP_MATSPECCOLOR | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_MATSPECCOLOR", (void*)&PSP_MATSPECCOLOR);

    // const StringHash PSP_METALLIC | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_METALLIC", (void*)&PSP_METALLIC);

    // const StringHash PSP_NEARCLIP | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_NEARCLIP", (void*)&PSP_NEARCLIP);

    // const StringHash PSP_NORMALOFFSETSCALE | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_NORMALOFFSETSCALE", (void*)&PSP_NORMALOFFSETSCALE);

    // const StringHash PSP_ROUGHNESS | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_ROUGHNESS", (void*)&PSP_ROUGHNESS);

    // const StringHash PSP_SHADOWCUBEADJUST | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_SHADOWCUBEADJUST", (void*)&PSP_SHADOWCUBEADJUST);

    // const StringHash PSP_SHADOWDEPTHFADE | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_SHADOWDEPTHFADE", (void*)&PSP_SHADOWDEPTHFADE);

    // const StringHash PSP_SHADOWINTENSITY | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_SHADOWINTENSITY", (void*)&PSP_SHADOWINTENSITY);

    // const StringHash PSP_SHADOWMAPINVSIZE | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_SHADOWMAPINVSIZE", (void*)&PSP_SHADOWMAPINVSIZE);

    // const StringHash PSP_SHADOWSPLITS | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_SHADOWSPLITS", (void*)&PSP_SHADOWSPLITS);

    // const StringHash PSP_VSMSHADOWPARAMS | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_VSMSHADOWPARAMS", (void*)&PSP_VSMSHADOWPARAMS);

    // const StringHash PSP_ZONEMAX | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_ZONEMAX", (void*)&PSP_ZONEMAX);

    // const StringHash PSP_ZONEMIN | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashPSP_ZONEMIN", (void*)&PSP_ZONEMIN);
    ...
    engine->RegisterGlobalProperty("const String HashVSP_AMBIENTENDCOLOR", (void*)&VSP_AMBIENTENDCOLOR);

    // const StringHash VSP_AMBIENTSTARTCOLOR | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_AMBIENTSTARTCOLOR", (void*)&VSP_AMBIENTSTARTCOLOR);

    // const StringHash VSP_BILLBOARDROT | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_BILLBOARDROT", (void*)&VSP_BILLBOARDROT);

    // const StringHash VSP_CAMERAPOS | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_CAMERAPOS", (void*)&VSP_CAMERAPOS);

    // const StringHash VSP_CLIPPLANE | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_CLIPPLANE", (void*)&VSP_CLIPPLANE);

    // const StringHash VSP_DELTATIME | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_DELTATIME", (void*)&VSP_DELTATIME);

    // const StringHash VSP_DEPTHMODE | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_DEPTHMODE", (void*)&VSP_DEPTHMODE);

    // const StringHash VSP_ELAPSEDTIME | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_ELAPSEDTIME", (void*)&VSP_ELAPSEDTIME);

    // const StringHash VSP_FARCLIP | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_FARCLIP", (void*)&VSP_FARCLIP);

    // const StringHash VSP_FRUSTUMSIZE | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_FRUSTUMSIZE", (void*)&VSP_FRUSTUMSIZE);

    // const StringHash VSP_GBUFFEROFFSETS | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_GBUFFEROFFSETS", (void*)&VSP_GBUFFEROFFSETS);

    // const StringHash VSP_LIGHTDIR | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_LIGHTDIR", (void*)&VSP_LIGHTDIR);

    // const StringHash VSP_LIGHTMATRICES | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_LIGHTMATRICES", (void*)&VSP_LIGHTMATRICES);

    // const StringHash VSP_LIGHTPOS | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_LIGHTPOS", (void*)&VSP_LIGHTPOS);

    // const StringHash VSP_MODEL | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_MODEL", (void*)&VSP_MODEL);

    // const StringHash VSP_NEARCLIP | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_NEARCLIP", (void*)&VSP_NEARCLIP);

    // const StringHash VSP_NORMALOFFSETSCALE | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_NORMALOFFSETSCALE", (void*)&VSP_NORMALOFFSETSCALE);

    // const StringHash VSP_SKINMATRICES | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_SKINMATRICES", (void*)&VSP_SKINMATRICES);

    // const StringHash VSP_UOFFSET | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_UOFFSET", (void*)&VSP_UOFFSET);

    // const StringHash VSP_VERTEXLIGHTS | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_VERTEXLIGHTS", (void*)&VSP_VERTEXLIGHTS);

    // const StringHash VSP_VIEW | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_VIEW", (void*)&VSP_VIEW);

    // const StringHash VSP_VIEWINV | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_VIEWINV", (void*)&VSP_VIEWINV);

    // const StringHash VSP_VIEWPROJ | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_VIEWPROJ", (void*)&VSP_VIEWPROJ);

    // const StringHash VSP_VOFFSET | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_VOFFSET", (void*)&VSP_VOFFSET);

    // const StringHash VSP_ZONE | File: ../GraphicsAPI/GraphicsDefs.h
    engine->RegisterGlobalProperty("const String HashVSP_ZONE", (void*)&VSP_ZONE);
