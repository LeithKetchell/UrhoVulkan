...
private:
    ...
    void Release_Vulkan();
    bool SetData_Vulkan(const void* data);
    bool SetDataRange_Vulkan(const void* data, i32 start, i32 count, bool discard = false);
    void* Lock_Vulkan(i32 start, i32 count, bool discard);
    void Unlock_Vulkan();
    bool Create_Vulkan();
